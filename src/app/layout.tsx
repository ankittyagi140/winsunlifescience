                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4">
                      <a href="https://www.facebook.com/share/1CxAyXWgSs/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-200 transition-colors touch-manipulation">
                      ...
                      <a href="https://www.linkedin.com/in/amit-kumar-tyagi-1683b52b/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-200 transition-colors touch-manipulation">
                        <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
